...
/*
 * -----------------------------------------------------------------------------
 * Функция преобразования полученных через USART данных в один байт
 * ow_bits - ссылка на буфер, размером не менее 8 байт
 * -----------------------------------------------------------------------------
 */
...
/*
 * -----------------------------------------------------------------------------
 * Функция сброса и проверка на наличие устройств на шине
 * -----------------------------------------------------------------------------
 */
uint8_t OW_Reset() {
    uint8_t              ow_presence;
 ...
 * sendReset - посылать ли RESET в начале общения
...
uint8_t OW_Send(uint8_t sendReset,
    ...
    /* Eсли требуется сброс - сбрасываем и проверяем на наличие устройств */
